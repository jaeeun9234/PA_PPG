...
%% ===== 0) 파일 지정 =====
% fname = "data_20260527_1149_trial3.csv";
fname = "data_20260527_1149.csv"
T = readtable(fname);
...
% save("breathhold_trial_spo2_sto2.mat", "SpO2_mat", "StO2_mat");


% spo2_mean = mean(SpO2_3, 2, 'omitnan');
% 
% sto2_mean = mean(StO2_3, 2, 'omitnan');

% t_common = (0:N-1)'/fs_PPG;

% spo2_trial_mean = mean(spo2_mat, 2, 'omitnan');
% sto2_trial_mean = mean(sto2_mat, 2, 'omitnan');

% save("SpO2_StO2_mean.mat","spo2_mean", "sto2_mean");
...
% plot(t, spo2_mean, 'r', 'LineWidth', 1.25);
plot(t, sto2_mean, 'b', 'LineWidth', 1.25);
