...
legend("\DeltaHbO2(env)", "\DeltaHHb(env)", "\DeltatHb(env)", "Location", "best");
...
legend("\DeltaHbO2", "\DeltaHHb", "Location", "best");
...
title("FFT of \DeltaHbT [AC] (0–5 Hz)");
...
title("\Delta HbO2 (env) [DC/AC]"); legend("\Delta HbO2 [DC] (env)", "\Delta HbO2 [AC]");
grid on;

figure;
plot(tt, dHHb_env, "LineWidth", 1.2); hold on; plot(tt, DHHb); 
title("\Delta HHb (env) [DC/AC]"); legend("\Delta HHb [DC] (env)", "\Delta HHb [AC]");
grid on;

figure;
plot(tt, dHbT_env, "LineWidth", 1.2); hold on; plot(tt, DtHb); 
title("\Delta tHb (env) [DC/AC]"); legend("\Delta tHb [DC] (env)", "\Delta tHb [AC]");
grid on;
